...
<body>
  <div class="jumbotron" style="background-color:white">
     <h1 class="text-center">Welcome to</h1>
      ...
      <h1>The Jenkins build had the typical Maven build steps:</h1>
      ...
      <p class="text-center"><b>If the Build Successful Ok,If it is failure send an Email notification alert to the development team.</b></p>
